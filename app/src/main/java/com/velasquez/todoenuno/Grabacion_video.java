...
public class Grabacion_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Permisos que debe dar el usuario para poder usar la cámara y el almacenamiento externo
